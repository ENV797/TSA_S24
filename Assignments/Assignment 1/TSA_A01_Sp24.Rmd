...
> Answer: I majored in stats when I was in undergrad so I had to use R and git frequently for my stats classes. I also took a time series analysis class and completed a project forecasting the solar development for NC state in the next decade. Also, last semester I also took class ENV872.
...
> Answer: 
https://github.com/zl396/TSA_Sp24
