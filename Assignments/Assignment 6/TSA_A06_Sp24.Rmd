...
```{r}
set.seed(123)
sarima_sim <- sim_sarima(n = 120, model = list(sar=0.8, ma=0.5, iorder=0, siorder=0, nseasons=12))
...
# ACF and PACF plots
plot_grid(
  autoplot(Acf(sarima_sim, plot = FALSE)) + ggtitle("ACF of Seasonal ARIMA"),
  autoplot(Pacf(sarima_sim, plot = FALSE)) + ggtitle("PACF of Seasonal ARIMA"),
  nrow = 1
)
```
