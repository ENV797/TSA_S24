...
for(i in 1:nhydro){
  print(ggplot(inflow_data, aes(x=my_date, y=inflow_data[,(1+i)])) + # 1+i here is to record the index of the column
...
## Check what happened to ACF after removing the seasonal component

## decompose

```{r}
decompose(ts_inflow_data)
